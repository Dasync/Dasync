...
namespace Dasync.ExecutionEngine.Modeling
{
    public class CommunicationModelEnricher : ICommunicationModelEnricher
    {
        ...
        private static void ReadMethodBahavior(IConfiguration config, IMutablePropertyBag propertyBag, string suffix)
        {
            ...
            if (behaviorOptions.InvokeInPlace.HasValue)
                propertyBag.AddProperty("invokeinplace" + suffix, behaviorOptions.InvokeInPlace.Value);
        }
        ...
        public class MethodBehaviorOptions
        {
            ...
            /// <summary>
            /// Prefer to invoke a query or a command in the same process instead of scheduling a message.
            ...
            /// </summary>
            public bool? InvokeInPlace { get; set; }
        }
