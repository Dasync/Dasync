...
{
    public class ProjectionTypeBuilder
    {
        ...
        static ProjectionTypeBuilder()
        {
            _moduleBuilder = new Lazy<ModuleBuilder>(() =>
            {
                var thisAssembly = typeof(ProjectionTypeBuilder).GetTypeInfo().Assembly;
